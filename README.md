...
| <a name="input_extra_ingress_rules_ipv4"></a> [extra\_ingress\_rules\_ipv4](#input\_extra\_ingress\_rules\_ipv4) | n/a | <pre>list(object({<br>    ip_protocol = optional(string, "tcp")<br>    from_port   = string<br>    to_port     = string<br>    cidr_ipv4   = string<br>  }))</pre> | `[]` | no |
